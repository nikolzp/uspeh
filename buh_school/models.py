...
class BuhDetail(models.Model):
    title = models.ForeignKey("BuhTitle", null=True, default=True, on_delete=models.CASCADE, related_name='design_title', verbose_name='Имя курса')
    ...
    def get_absolute_url(self):
        return reverse('buh_school_detail')


class BuhTitle(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('buh_school_create_det')