...
class GraphDetail(models.Model):
    title = models.ForeignKey("GraphTitle", null=True, default=True, on_delete=models.CASCADE, related_name='design_title', verbose_name='Имя курса')
    ...
    def get_absolute_url(self):
        return reverse('graph_school_detail')


class GraphTitle(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('graph_school_create_det')