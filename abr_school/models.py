...
class ABRDetail(models.Model):
    title = models.ForeignKey("ABRTitle", null=True, default=True, on_delete=models.CASCADE, related_name='design_title', verbose_name='Имя курса')
    ...
    def get_absolute_url(self):
        return reverse('abr_school_detail')


class ABRTitle(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('abr_school_create_det')