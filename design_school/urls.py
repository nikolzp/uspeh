...
from design_school.views import DesignSchoolDetail, DesignSchoolCreateView, DesignSchoolTitleView, DesignSchoolDetailUpdateView, DesignSchoolDetailDeleteView, DesignSchoolTitleUpdateView, group, DesignSchoolGroupDetView
...
urlpatterns = [
    ...
    path('group-det/', DesignSchoolGroupDetView.as_view(), name='design_school_group_det'),
]